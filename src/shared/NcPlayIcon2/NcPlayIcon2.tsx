...
const NcPlayIcon2: FC<NcPlayIcon2Props> = ({ className = 'w-8 h-8 md:w-10 md:h-10', iconClass = 'w-5 h-5' }) => {
    return (
        <div className={`nc-NcPlayIcon2 bg-white relative rounded-full shadow-inner ${className}`} data-nc-id="NcPlayIcon2">
