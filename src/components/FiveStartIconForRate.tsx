...
const FiveStartIconForRate: FC<FiveStartIconForRateProps> = ({ className = '', iconClass = 'w-4 h-4', defaultPoint = 5 }) => {
    ...
    return (
        <div className={`nc-FiveStartIconForRate flex items-center text-neutral-300 ${className}`} data-nc-id="FiveStartIconForRate">
            {[1, 2, 3, 4, 5].map((item) => {
                return (
                    <StarIcon
                        key={item}
