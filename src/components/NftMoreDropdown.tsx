...
const NftMoreDropdown: FC<NftMoreDropdownProps> = ({
    ...
    const renderMenu = () => {
        return (
            <NcDropDown
                ...
                iconClass={iconClass}
                data={actions}
                panelMenusClass={dropdownPositon === 'up' ? 'origin-bottom-right bottom-0 ' : 'origin-top-right !w-44 sm:!w-52'}
    ...
    return (
        <div className="">
            ...
            <ModalTransferToken show={isTransfering} onCloseModalTransferToken={closeModalTransferToken} />
        </div>
    )
}
